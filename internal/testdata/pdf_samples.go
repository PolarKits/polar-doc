...
var pdfSamples = []PDFSample{
	...
	{Key: "version-compat-v1.2", Filename: "test_ver_compat_v1.2.pdf", Category: "version-compat", Description: "Version compatibility fixture for PDF 1.2", DeclaredVersionHint: "1.2", Integrity: PDFSampleIntegrityValid, ExpectFirstPageInfo: true, ExpectExtractText: true, ExpectFileIDs: true},
	...
	{Key: "feature-layers", Filename: "test_feat_layers_v1.5.pdf", Category: "feature", Description: "Optional Content Groups (layers) fixture for PDF 1.5", DeclaredVersionHint: "1.5", Integrity: PDFSampleIntegrityValid, ExpectFirstPageInfo: true, ExpectExtractText: true, ExpectFileIDs: true},
	{Key: "feature-signed", Filename: "test_feat_signed_v1.7.pdf", Category: "feature", Description: "Digital signature fixture for PDF 1.7", DeclaredVersionHint: "1.7", Integrity: PDFSampleIntegrityValid, ExpectFirstPageInfo: true, ExpectExtractText: true, ExpectFileIDs: true},
	{Key: "standard-pdf20-offset", Filename: "test_std_pdf20_offset_v2.0.pdf", Category: "standard", Description: "PDF 2.0 with offset fixture", DeclaredVersionHint: "2.0", Integrity: PDFSampleIntegrityValid, ExpectFirstPageInfo: false, ExpectExtractText: false, ExpectFileIDs: false},
