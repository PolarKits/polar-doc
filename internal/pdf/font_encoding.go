...
// macExpertMapping maps MacExpertEncoding bytes 128-255 to Unicode runes.
// MacExpertEncoding is a PostScript encoding used for expert fonts.
// It is similar to MacRoman but with differences in the high range.
// Source: Adobe PostScript Language Reference, Appendix C.
var macExpertMapping = map[byte]rune{
	// MacExpertEncoding table (128-255)
	0x80: '\u00C4', // Latin capital letter A with diaeresis (Ä)
	0x81: '\u00C5', // Latin capital letter A with ring above (Å)
	0x82: '\u00C7', // Latin capital letter C with cedilla (Ç)
	0x83: '\u00C9', // Latin capital letter E with acute (É)
	...
	0xB3: '\u2265', // Greater-than or equal to (≥)
	0xB4: '\u00B5', // Micro sign (µ)
	0xB5: '\u2202', // Partial differential (∂)
	0xB6: '\u2211', // N-ary summation (∑)
	0xB7: '\u220F', // N-ary product (∏)
	0xB8: '\u03C0', // Greek small letter pi (π)
	0xB9: '\u222B', // Integral (∫)
	0xBA: '\u00AA', // Feminine ordinal indicator (ª)
	0xBB: '\u00BA', // Masculine ordinal indicator (º)
	0xBC: '\u03A9', // Greek capital letter omega (Ω)
	0xBD: '\u00E6', // Latin small ligature ae (æ)
	0xBE: '\u00F8', // Latin small letter o with stroke (ø)
	0xBF: '\u00FF', // Latin small letter y with diaeresis (ÿ)
	0xC0: '\u00C0', // Latin capital letter A with grave (À)
	0xC1: '\u00C3', // Latin capital letter A with tilde (Ã)
	0xC2: '\u00C5', // Latin capital letter A with ring above (Å)
	0xC3: '\u00C2', // Latin capital letter A with circumflex (Â)
	0xC4: '\u00C6', // Latin capital ligature AE (Æ)
	0xC5: '\u00CD', // Latin capital letter I with acute (Í)
	0xC6: '\u00CE', // Latin capital letter I with circumflex (Î)
	0xC7: '\u00CF', // Latin capital letter I with diaeresis (Ï)
	0xC8: '\u00D0', // Latin capital letter Eth (Ð)
	0xC9: '\u00E4', // Latin small letter a with diaeresis (ä)
	0xCA: '\u00E5', // Latin small letter a with ring above (å)
	0xCB: '\u00E6', // Latin small ligature ae (æ)
	0xCC: '\u0131', // Latin small letter dotless i (ı)
	0xCD: '\u00F0', // Latin small letter eth (ð)
	0xCE: '\u00E2', // Latin small letter a with circumflex (â)
	0xCF: '\u00E9', // Latin small letter e with acute (é)
	0xD0: '\u00EA', // Latin small letter e with circumflex (ê)
	0xD1: '\u00E0', // Latin small letter a with grave (à)
	0xD2: '\u00D4', // Latin capital letter O with circumflex (Ô)
	0xD3: '\u00D3', // Latin capital letter O with acute (Ó)
	0xD4: '\u00D5', // Latin capital letter O with tilde (Õ)
	0xD5: '\u2021', // Double dagger (‡)
	0xD6: '\u00F7', // Division sign (÷)
	0xD7: '\u25CA', // Lozenge (◊)
	0xD8: '\u00B8', // Cedilla (¸)
	0xD9: '\u00C8', // Latin capital letter E with grave (È)
	0xDA: '\u00C9', // Latin capital letter E with acute (É)
	0xDB: '\u00CA', // Latin capital letter E with circumflex (Ê)
	0xDC: '\u00CB', // Latin capital letter E with diaeresis (Ë)
	0xDD: '\u00EB', // Latin small letter e with diaeresis (ë)
	0xDE: '\u2022', // Bullet (•)
	0xDF: '\u00B7', // Middle dot (·)
	0xE0: '\u00F4', // Latin small letter o with circumflex (ô)
	0xE1: '\u00F6', // Latin small letter o with diaeresis (ö)
	0xE2: '\u00F5', // Latin small letter o with tilde (õ)
	0xE3: '\u02C6', // Modifier letter circumflex accent (ˆ)
	0xE4: '\u02DC', // Small tilde (˜)
	0xE5: '\u2026', // Horizontal ellipsis (…)
	0xE6: '\u00BC', // Vulgar fraction one quarter (¼)
	0xE7: '\u00BD', // Vulgar fraction one half (½)
	0xE8: '\u00BE', // Vulgar fraction three quarters (¾)
	0xE9: '\u00A5', // Yen sign (¥)
	0xEA: '\u00A9', // Copyright sign (©)
	0xEB: '\u00A7', // Section sign (§)
	0xEC: '\u00B6', // Pilcrow sign (¶)
	0xED: '\u00AC', // Not sign (¬)
	0xEE: '\u00A4', // Currency sign (¤)
	0xEF: '\u00A0', // Non-breaking space
	0xF0: '\u00E1', // Latin small letter a with acute (á)
	0xF1: '\u00ED', // Latin small letter i with acute (í)
	0xF2: '\u00F3', // Latin small letter o with acute (ó)
	0xF3: '\u00FA', // Latin small letter u with acute (ú)
	0xF4: '\u00F1', // Latin small letter n with tilde (ñ)
	0xF5: '\u00D1', // Latin capital letter N with tilde (Ñ)
	0xF6: '\u00A8', // Diaeresis (¨)
	0xF7: '\u0020', // Space
	0xF8: '\u0020', // Space
	0xF9: '\u0020', // Space
	0xFA: '\u0020', // Space
	0xFB: '\u02C6', // Modifier letter circumflex accent (ˆ)
	0xFC: '\u02DC', // Small tilde (˜)
	0xFD: '\u02DA', // Ring above (˚)
	0xFE: '\u00B8', // Cedilla (¸)
